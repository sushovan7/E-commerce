  ...
  return (
    <>
      <div className="product-page h-screen w-4/5 mt-5 relative left-1/2 translate-x-[-50%] flex gap-3 ">
        <div className="description text-3xl font-bold italic absolute left-1/2 top-7 translate-x-[-50%] ">
          {item[0].description}
        </div>
        <div className="left h-4/5 w-1/2 bg-gray-300 p-5  flex flex-col gap-10 ">
          <div className="product-details mt-10 ">
            <p className="text-lg font-normal">{item[0].specs}</p>
          </div>
        ...
        <div className="right w-1/2 h-full  p-10">
          ...
          <div className="more-img w-full h-2/6 -mt-10  flex items-center justify-between ">
            <img
              className="object-center object-cover h-1/2 mr-2"
              onMouseOver={changeImage}
              src={item[0].img}
              alt="product"
            />
            ...
            />
            <img
              className="object-center object-cover h-1/2"
              onMouseOver={changeImage}
